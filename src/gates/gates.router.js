...
router.get('/', passport.authenticate('jwt', { session: false }), isActive(), GatesController.get);
router.get('/:id', passport.authenticate('jwt', { session: false }), isActive(), GatesController.getById);
