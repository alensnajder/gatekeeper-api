...
router.get('/', passport.authenticate('jwt', { session: false }), isActive(), UsersController.get);
router.get('/:id', passport.authenticate('jwt', { session: false }), isActive(), UsersController.getById);
